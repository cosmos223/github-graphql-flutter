...
import 'package:github_graphql/GraphQL/UpdateIssue.graphql.dart';

class EditIssuePage extends HookWidget {
  const EditIssuePage(this.id, this.titleText, this.bodyMarkDown, {super.key});
  final String id;
  ...
  Widget build(BuildContext context) {
    ...
    final mutation = useMutation$UpdateIssue(); // ← useMutationはここで呼び出す必要あり
